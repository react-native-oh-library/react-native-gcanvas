...
#ifndef GCANVAS_GCANVAS2DCONTEXTHARMONY_H
#define GCANVAS_GCANVAS2DCONTEXTHARMONY_H
...
class GCanvas2DContextHarmony : public GCanvasContext {


public:


    GCanvas2DContextHarmony(uint32_t width, uint32_t h, GCanvasConfig &config);


    virtual ~GCanvas2DContextHarmony();
...
#endif //GCANVAS_GCANVAS2DCONTEXTHARMONY_H
