...
#ifndef GCANVAS_GFontManagerHarmony_H
#define GCANVAS_GFontManagerHarmony_H
...
class GFontManagerHarmony : public GFontManager
{
public:

    GFontManagerHarmony(GCanvasContext *context);

    virtual ~GFontManagerHarmony();
...
#endif //GCANVAS_GFontManagerHarmony_H
